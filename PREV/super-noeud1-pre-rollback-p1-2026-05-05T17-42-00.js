...
// --- P11 : Étoiles fixes amplificatrices (FIX Sprint 4.2 — 2026-05-05) ---
// AVANT : positions hardcodées J2000.0 sans précession (erreur ~1°/72ans)
// APRÈS : lecture de etoileMatchesNatal/etoileCuspMatchesNatal (calcul amont
...
try {
  ...
  for (const em of (etoileMatchesNatal || [])) {
    ...
    if (!Number.isFinite(orb) || orb > 1.5) continue;
